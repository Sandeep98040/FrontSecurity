  ...
  return (
    <>
      ...
      <div className="text-3xl p-2 font-bold">
        Welcome to Samaan Kinam E-commerce
      </div>
          ...
          return products.map((product) => {
            return (
              <div className="carousel-item mr-5" key={product.id + i}>
                <img
                  src={`https://localhost:4000/product/${product.picture}`}
                  alt="Drink"
                />
              </div>
            );
      ...
      <div className="card lg:card-side bg-base-100 shadow-xl single-row-card">
        <figure>
          <img
            src={`https://localhost:4000/product/${newReleasedProduct.picture}`}
          />
        </figure>
      ...
      <div className="hero bg-base-200 mb-8">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <img
            id="right-card"
            src={`https://localhost:4000/product/${hottestProduct.picture}`}
